...
const STAGE_STYLES: Record<OrderStage, string> = {
  ...
  measurement: "bg-violet-100 text-violet-800 dark:bg-violet-900 dark:text-violet-100",
  fabrication: "bg-brand/15 text-brand dark:text-brand-foreground",
  ready_for_install: "bg-amber-100 text-amber-900 dark:bg-amber-900 dark:text-amber-100",
